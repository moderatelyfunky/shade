...
btnCircle1 = tk.Button(app, image=roundButton, borderwidth=0, command=doSomething).grid(row=2, column=0, rowspan=2, columnspan=2)
btnCircle2 = tk.Button(app, image=roundButton, borderwidth=0, command=doSomething).grid(row=2, column=3, rowspan=2, columnspan=2)
...
btnLeftShadeLeft = tk.Button(app, image=arrowLeft, borderwidth=0, command=doSomething).grid(row=4, column=0)
btnLeftShadeRight = tk.Button(app, image=arrowRight, borderwidth=0, command=doSomething).grid(row=4, column=1)
