...
btnTopShadeDown = tk.Button(app, name="btnTopShadeDown", image=arrowRight, borderwidth=0)
...
btnBottomShadeDown = tk.Button(app, name="btnBottomShadeDown", image=arrowRight, borderwidth=0)
